    ...
    return (
        <div>
            ...
            <div className="p-14">
                ...
                <div data-aos="zoom-in" data-aos-duration="2000" className="flex flex-col lg:flex-row justify-center items-center gap-8">
